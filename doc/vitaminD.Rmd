...
vitd %>%
  ...
  dplyr::summarise(Median = median(log(udbpCrRatio)), 
                   IQR = IQR(log(udbpCrRatio))
                   )
...
rms::ols(VitaminD ~ udbpCrRatio * Season, data = dsBase)
```
...
rms::ols(VitaminD ~ udbpCrRatio * Season, data = ds)
```
